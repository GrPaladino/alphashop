...
export class ArticoliService {
  ...
  articoli: IArticoli[]  = [
    {codart : '014600301', descrizione : 'BARILLA FARINA 1 KG', um : 'PZ', pzcart : 24, peso : 1, prezzo : 1.09, active : false, data : new Date(), imageUrl: 'assets/images/prodotti/014600301.jpg'},
